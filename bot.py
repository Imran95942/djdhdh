...
async def mentionall(event):
  ...
  if not event.sender_id in admins:
    return await event.respond("__Bütün bunlar haqqında yalnız adminlər danışa bilər!__")
  ...
  if event.pattern_match.group(1):
    ...
    return await event.respond("__Mesajı cavablandırın və ya başqalarını qeyd etmək üçün mənə mətn yazın__")
